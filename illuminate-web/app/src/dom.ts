// Tiny DOM builder. Every text node goes through textContent, so titles, tags,
// and source names from the API can never inject markup — no innerHTML of raw
// API strings anywhere in the app.
